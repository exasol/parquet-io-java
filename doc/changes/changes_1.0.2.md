...
* Added `org.scala-lang:scala-library:2.12.14`

### Test Dependency Updates

* Added `org.hamcrest:hamcrest:2.2`
* Added `org.junit.jupiter:junit-jupiter:5.7.2`
* Added `org.mockito:mockito-core:3.11.2`
...
* Added `net.alchim31.maven:scala-maven-plugin:4.5.3`
...
* Added `org.apache.maven.plugins:maven-javadoc-plugin:3.3.0`
