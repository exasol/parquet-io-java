...
final class ParquetTimestampNanosConverter extends PrimitiveConverter implements ParquetConverter {
     ...
     */
    ParquetTimestampNanosConverter(final int index, final ValueHolder holder, final boolean adjustedToUTC) {
        this.index = index;
        this.holder = holder;
    ...
    public void addLong(final long value) {
        this.holder.put(this.index, this.adjustedToUTC ? DateTimeHelper.getTimestampFromNanos(value)
                : DateTimeHelper.getLocalTimestampFromNanos(value));
    }
}
